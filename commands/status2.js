    ...
    execute(channel, message, client, args) {
        ...
        if (args[0] && args[0].toLowerCase() === 'streaming') {
            ...
            const r = new Discord.RichPresence()
                .setType('STREAMING')
                .setURL('https://www.twitch.tv/pewdiepie')
                .setState('Working On PG Host')
                .setName('YGamer')
                .setDetails('Working On PG Host')
                ...
                .setAssetsSmallText('No Hello')
                .addButton('PG Host', 'https://discord.gg/pghost')
                .addButton('No Hello', 'https://nohello.net');
